  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-slate-950 dark:via-blue-950 dark:to-purple-950">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-32 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-36 max-w-2xl mx-auto text-lg sm:text-xl text-muted-foreground leading-relaxed">
      ...
      <section className="py-20 sm:py-32">
        <div className="mx-auto max-w-7xl x-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <Card className="relative overflow-hidden border-2 border-purple-300 dark:border-purple-700 hover:border-purple-500 dark:hover:border-purple-500 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 group bg-gradient-to-br from-purple-50/80 via-pink-50/80 to-orange-50/80 dark:from-purple-950/80 dark:via-pink-950/80 dark:to-orange-950/80 ">
              ...
              <CardHeader className="relative">
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-2 rounded-lg bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 text-white">
                    <MessageSquare className="w-6 h-6" />
                  </div>
                  <Badge className="bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 hover:from-purple-200 hover:to-pink-200 dark:from-purple-900 dark:to-pink-600 dark:text-purple-300 border-0">
                    Pro
                  </Badge>
                </div>
                ...
                <CardDescription className="text-base">
                  Everything in the starter, plus the power to have intelligent
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-sm ">
                    <CheckCircle className="w-4 h-4 text-green-600" />
                    <span>Get acctionable reccomendations</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm ">
                    <CheckCircle className="w-4 h-4 text-green-600" />
      ...
      <section className="py-20 sm:py-32 bg-gradient-to-r from-emerald-50/50 via-blue-50/50 to-purple-50/50 ">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">
              Simple, Transparent Pricing
            </h2>
            <p className="text-lg text-mute-foreground">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            {/* Pro Pricing */}
            <Card className=" relative border-2 border-purple-300 dark:border-purple-700 hover:border-purple-500 hover:shadow-xl hover:shadow-purple-500/20 bg-gradient-to-br from-purple-50/80 via-pink-50/80 to-rose-50/80 dark:from-purple-950/80 dark:via-pink-950/80 dark:to-rose-950/80">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-600" />
                    <span className="text-sm">AI Chat with reports</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-600" />
      ...
      <section className="py-20">
        <div className="mx-auto mac-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
              <Shield />
              <span>Enterprise security & 99.9& uptime guaranteed</span>
            </div>
          </div>
        </div>
      </section>
