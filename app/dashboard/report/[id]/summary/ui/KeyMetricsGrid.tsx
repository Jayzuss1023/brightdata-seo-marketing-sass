  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
      ...
      <Card className="relative overflow-hidden border bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 group hover:shadow-md transition-all duration-300">
        <div className="bg-green-400/10 rounded-full overflow-hidden w-20 h-20 absolute top-0 right-0 -translate-y-10 translate-x-10 group-hover:scale-150 transition-transform duration-500" />
        <CardContent className="p-6 relative">
          <div className="flex items-center justify-between mb-4">
            <div>
      ...
      {/* Unique Domains */}
      <Card className="relative overflow-hidden border bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-maber-950/30 group hover:shadow-md transition-all duration-300">
