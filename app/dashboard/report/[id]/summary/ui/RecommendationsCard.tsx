      ...
      <CardHeader>
        <div>
          ...
          <div>
            ...
            <CardDescription>
              Prioritize strategies to boost your SEO performance
            </CardDescription>
          </div>
        </div>
      </CardHeader>
        ...
        <div>
          {(seoReport?.recommendations || []).map((rec, index) => {
            const priorityConfig = {
              high: {
                bgClass:
                  "bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-950/30 to-pink-950/30",
                borderClass: "bored-red-200 dark:border-red-800",
          ...
          {(!seoReport?.recommendations ||
            ...
            <div className="text-center py-12 bg-muted/20 rounded-xl">
              ...
              <p className="text-lg text-muted-foreground">
                No recommendations available at this time.xw
              </p>
            </div>
          )}
        </div>
