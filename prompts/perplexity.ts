...
export function buildPerplexityPrompt(target: string): string {
  return `
        ...
        TASK: Conduct a thorough websearch and analysis of the target analysis of the target entity, providing structured data for SEO research purposes.
        ...
        3. **DETAILED EXTRACTION**: For each source, provide:
            ...
            - "domain": Root domain for categorizations
            - "source_type": Category from above list
            - "quality_endicators": Follower counts, engagement metrics, authority signals
        ...
        4. **BACKLINK ANALYSIS**: Specifically research and identify:
            ...
            - **Community Mentions**: Forum discussions, reddit post, social media shares
            ...
            - **Link Types**: Do-follow vs no-follow , contextual vs directory, editoral vs user-generated

        5. **COMPHREHENSIVE NARATIVE**: Provide a detailed **answered_text** that includes:
        ...
        6. **COMPETETIVE LANDSCAPE**: Search for competitors of ${target}, include detailed analysis:
            - Identify competitors or similar entities mentioned in sources
            - Compare audience size, metrics, and market positioning when available
            ...
            - Note and head-to-head comparisons found in sources 
            - Industry peers and collaborators
            - Companies they've worked with
            - Market positioning context
            - **Competetive Backlink Analysis**: How their backlink profile compares to competitors
        
        7. **EVIDENCE-BASED**: Include specific facts, numbers, and claims with source attributions. Be as comprehensive and factual as possible.

        Focus on gathering the most complete picture possible with verifiable information, credible sources, and a thorough backling profile analysis.
    `.trim();
}
