    ...
    <>
      ...
      {isExpanded && (
        <div className="fixed bottom-20 right-6 z-50 w-[500px] h-[600px] bg-white rounded-3xl shadow-2xl border border-gray-100 flex flex-col overflow-hidden">
          {/* Header */}
          <div className="flex items-center justify-between p-5 text-white bg-gradient-to-r from-indigo-600 to-purple-600 rounded-t-3xl">
          ...
          <div ref={chatRef} className="flex-1 overflow-y-auto p-6 space-y-4">
            ...
            {messages.map((message) => (
              ...
              >
                <div
                  className={cn(
                    "max-w-[85%] px-4 py-3 rounded-2xl text-xs shadow-sm",
                    message.role === "user"
